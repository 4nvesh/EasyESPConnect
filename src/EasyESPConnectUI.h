...
<!doctypehtml><html lang=en><meta charset=UTF-8><meta content="IE=edge"http-equiv=X-UA-Compatible><meta content="width=device-width,initial-scale=1"name=viewport><title>Credentials Saved</title><div class=info-div><p class=info-para>Wi-Fi credentials are saved. Device will restart in 5 seconds.</div><style>body{display:flex;justify-content:center}.info-div{margin-top:20px;display:flex;justify-content:center;align-items:center;width:260px;height:90px;background-color:#f5f5f5;border-radius:12px}.info-para{width:80%;font-style:normal;font-family:monospace;font-weight:500;font-size:16px;line-height:18px;color:#595959dd}</style></html>
)rawliteral";
